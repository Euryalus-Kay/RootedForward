...
/*  could live in it. Same player, map, and plate design as the        */
/*  earlier Jackson Park walk (that tour's data survives in            */
/*  jackson-park-walk.ts). The map is our own SVG built from Census    */
/*  TIGER geometry; the audio is pregenerated and served from /public. */
/*                                                                     */
