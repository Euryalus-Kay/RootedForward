...
/* ------------------------------------------------------------------ */
/*  HIDDEN (owner request, July 2026). This is the previous /tours    */
/*  index page, preserved intact. The live page.tsx is now the        */
/*  Jackson Park self-paced audio walking tour.                       */
/*                                                                     */
/*  To restore this page:                                             */
/*    1. Rename the current page.tsx (the audio tour) to another      */
/*       route, for example src/app/tours/jackson-park/page.tsx.      */
/*    2. Rename this file back to page.tsx.                           */
/*    3. Nothing else changes; navbar and footer already link /tours. */
/* ------------------------------------------------------------------ */
