...
const CHICAGO_NEIGHBORHOODS = [
  ...
  "Dunning", "East Garfield Park", "East Side", "Edgewater", "Edison Park", "Englewood",
  "Forest Glen", "Fuller Park", "Gage Park", "Garfield Ridge", "Grand Boulevard", "Greater Grand Crossing",
  ...
  "Norwood Park", "Oakland", "O'Hare", "Pilsen", "Portage Park",
