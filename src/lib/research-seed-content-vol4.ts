...
export const CROSS_BRONX_EXPRESSWAY_BODY = [
  ...
  "```map",
  "{",
  '  "title": "Cross Bronx Expressway corridor and quarter mile study tracts",',
  '  "caption": "The seven mile Cross Bronx trench bisects the South Bronx east to west. The quarter mile study buffer captures the tracts examined for displacement history, air quality, noise, and respiratory health outcomes.",',
  '  "zones": [',
  '    {"x": 2, "y": 28, "w": 96, "h": 18, "style": "dashed"}',
  "  ],",
  '  "roads": [',
  '    {"points": "2,36 98,37", "highway": true},',
  '    {"points": "0,10 100,10"},',
  '    {"points": "0,60 100,60"},',
  '    {"points": "25,0 25,75"},',
  '    {"points": "55,0 55,75"},',
  ...
  "  ],",
  '  "labels": [',
  '    {"x": 50, "y": 34, "text": "Cross Bronx Expressway (I-95)", "type": "street"},',
  '    {"x": 12, "y": 20, "text": "Morris Heights", "type": "neighborhood"},',
  '    {"x": 42, "y": 20, "text": "Tremont", "type": "neighborhood"},',
  '    {"x": 88, "y": 20, "text": "Parkchester", "type": "neighborhood"},',
  '    {"x": 25, "y": 73, "text": "Grand Concourse", "type": "street"},',
  '    {"x": 55, "y": 73, "text": "Southern Blvd", "type": "street"},',
  '    {"x": 78, "y": 73, "text": "White Plains Rd", "type": "street"}',
  "  ],",
  '  "markers": [',
  '    {"x": 50, "y": 37, "label": "Study corridor", "primary": true}',
  "  ],",
  '  "scale": {"length": 20, "label": "about 1.4 miles"}',
  "}",
  "```",
  "",
