...
export const AUSTIN_CBA_PLAYBOOK_BODY = [
  ...
  "",
  "Our contribution is threefold. First, we provide a structured comparison of eight Chicago CBAs with outcome data through year-end 2024, using a coding schema drawn from Park and Kim's (2022) ten-city framework. Second, we identify five structural features that correlate with post-signing compliance in the Chicago sample, extending the Park and Kim findings from their broader sample to the Chicago subset. Third, we offer specific negotiation recommendations for the Austin environment, derived from the empirical patterns we document and tailored to the four-site configuration the Austin Coming Together planning document identifies.",
  "",
...
export const BRONZEVILLE_TIF_ANALYSIS_BODY = [
  ...
  "",
  "Our contribution is twofold. First, the single-district lifetime accounting we present is more detailed than any prior published Chicago TIF analysis. The Chicago Civic Lab's TIF Illumination Project has published annual summary data for every district from 2013 onward but has not produced a full twenty-three-year reconciled accounting for any individual district. Weber's (2015) *From Boom to Bubble* treats the TIF system at the aggregate level without drilling into single-district expenditure paths. Our Bronzeville accounting fills this gap and establishes a methodology that can be applied to other districts. Second, the Bronzeville case provides an instructive comparison for the broader distributional question — how does a TIF district's expenditure allocation compare across districts covering higher- and lower-income areas of the city? — which the comparative context in §4.6 addresses directly.",
  "",
  "## 2. Background and Related Literature",
  "",
...
export const PROPERTY_TAX_APPEAL_DISPARITY_BODY = [
  ...
  "",
  "Our contribution is threefold. First, we present the first published full-population analysis of Cook County property-tax appeals, using administrative data obtained through FOIA covering the complete 2015–2024 record — 1.7 million filings, roughly one-fifth of all US metropolitan appeals filed during the period. Second, we extend AHM's two-channel decomposition to a single large county with detailed local administrative data, producing a more granular treatment of the appeals channel than was possible in their nationwide dataset. Third, we document the role of specialized property-tax law firms in producing the filing-rate and success-rate disparities — a mechanism that has been hypothesized in the prior literature (notably Kriticos 2020) but has not, to our knowledge, been quantified at the full-population level for any US jurisdiction.",
  "",
  "## 2. Background and Related Literature",
  "",
