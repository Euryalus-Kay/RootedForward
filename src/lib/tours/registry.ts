...
const ALL_WALKS: WalkTourBundle[] = [
  ...
  },
  {
    ...
    page: {
      ...
      metaDescription:
        "A free self-guided audio tour of Morningside Heights and West Harlem, from Columbia's gate on Broadway to the Hudson at West Harlem Piers. Six stops over about two and a half miles, on how a university, a church and a city decided what would happen to the ground around them, and how the people living beside them answered.",
